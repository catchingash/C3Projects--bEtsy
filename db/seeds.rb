...
products = [
  ...
  },
  {
    ...
    description: "Good for watercolor and pen. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Price per class hour per student. :) " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Trees not included. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Some assembly and parts required. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Check outside your door, especially during the summer. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "What more do we need to say? This is a great deal! " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Vintage! " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Passion Butterfly. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Don't stare at it too long. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Great source of Vitamin A! Good for night vision. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Stick out your tongue at pedestrians as you zoom by. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Comes with two extra faces & a Lego Jail Cell kit. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Seats two. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "No assembly required. Ships whole. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Tell us your favorite color. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    photo_url: "https://c1.staticflickr.com/3/2856/10515623584_a1a1371b85_n.jpg",
    description: "We have a lot. Overstock special pricing! " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Normally retails for over $500! " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Good for tables & walls. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "We opened the box. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Watch out for the beak. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Good for measuring triangles like this. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Come this way if you want to live. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
    ...
    description: "Only one broken window on the north side of the building! " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Does what it says on the tin. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "So soft. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  },
  {
  ...
  },
  {
    ...
    description: "Aperture Science? We do what we must because we can. " + lorem_ipsum_description, weight: rando_weight, length: rando_dimension, height: rando_dimension, width: rando dimension
  }
]
